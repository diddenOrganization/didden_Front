...
import {View, Button, StyleSheet, Text, TextInput, Alert, ActivityIndicator, TouchableOpacity} from 'react-native';
    ...
    <View style={styles.container}>
      <View style={styles.rowContainer}>
        <TextInput
          ...
          placeholder="이메일"
        />
        <TouchableOpacity style={styles.authButton} onPress={onEmailCheck}>
      ...
      <TouchableOpacity style={styles.submitButton} onPress={onJoinMember}>
